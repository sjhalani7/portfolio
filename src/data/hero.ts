export const heroContent = {
  kicker: "Hi, I’m",
  name: "Shiv Jhalani",
  pills: ["Software Engineer @ INRIX", "Data • Product • AI Systems"],
  note: "* P.S. I just love using em-dashes, I promise it’s not what it looks like.",
  paragraphs: [
    "Hi, I’m Shiv Jhalani — a software engineer at INRIX with a strong interest in data, product engineering, and modern AI-driven systems.",
